...
function errorMessage(code) {
  const map = {
    ...
    TEAM_MEMBER_NOT_FOUND: "Play2Prove account not found. Ask this player to create a Play2Prove account first using their Email, Username, or Player ID.",
  };
